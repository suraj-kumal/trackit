        ...
        const loadData = async () => {
            ...
            try {
                ...
                if (transData) {
                    ...
                    transData.item_performance.forEach(
                        (item: ItemPerformance) => itemIds.add(item.item_id),
                    );
                                    ...
                                    >
                                                ...
                                                <CardContent>
                                                    ...
                                                    <div className="flex items-center text-xs text-muted-foreground">
                                                        ...
                                                        <span className="text-green-500 font-medium">
                                                            {transactionData?.weekly_growth_rate_percent ||
                                                                0}
                                                            %
                                                        </span>
                                                        <span className="ml-1">
                                        ...
                                        >
                                            <Card>
                                                ...
                                                <CardContent>
                                                    <div className="text-xl lg:text-2xl font-bold">
                                                        {formatCurrency(
                                                            transactionData?.total_net_profit ||
                                                                0,
                                                        )}
                                                    </div>
                                        ...
                                        >
                                            <Card>
                                                ...
                                                <CardContent>
                                                    <div className="text-xl lg:text-2xl font-bold">
                                                        {transactionData?.total_sell ||
                                                            0}
                                                    </div>
                                                    <div className="text-xs text-muted-foreground">
                                                        <span className="font-medium">
                                                            {transactionData?.stock_left ||
                                                                0}
                                                        </span>
                                                        <span className="ml-1">
                                                            items in stock
                                            ...
                                            <Card>
                                                ...
                                                <CardContent>
                                                    ...
                                                    <div className="text-xs text-muted-foreground">
                                                        <span className="font-medium">
                                                            {formatCurrency(
                                                                transactionData?.total_investment ||
                                                                    0,
                                                            )}
                                                        </span>
                                                        <span className="ml-1">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                    <div className="space-y-1">
                                                        ...
                                                        <p className="text-xl lg:text-2xl font-bold">
                                                            {formatCurrency(
                                                                transactionData?.this_week_revenue ||
                                                                    0,
                                                            )}
                                                        </p>
                                                        <p className="text-xs text-muted-foreground">
                                                            Avg.{" "}
                                                            {formatCurrency(
                                                                transactionData?.avg_daily_revenue ||
                                                                    0,
                                                            )}
                                                            /day
                                                        </p>
                                                    ...
                                                    <div className="space-y-1">
                                                        ...
                                                        <p className="text-xl lg:text-2xl font-bold">
                                                            {formatCurrency(
                                                                transactionData?.this_week_net_profit ||
                                                                    0,
                                                            )}
                                                        </p>
                                                        <p className="text-xs text-muted-foreground">
                                                    ...
                                                    <div className="space-y-1">
                                                        ...
                                                        <p className="text-xl lg:text-2xl font-bold">
                                                            {transactionData?.weekly_sales_volume ||
                                                                0}
                                                        </p>
                                                        <p className="text-xs text-muted-foreground">
                                                            Avg.{" "}
                                                            {transactionData?.avg_daily_sales?.toFixed(
                                                                1,
                                                            )}
                                                            /day
                                                        </p>
                                            ...
                                            <CardContent>
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                    <div className="space-y-1">
                                                        ...
                                                        <p className="text-xl lg:text-2xl font-bold">
                                                            {formatCurrency(
                                                                transactionData?.this_month_revenue ||
                                                                    0,
                                                            )}
                                                        </p>
                                                        <p className="text-xs text-muted-foreground">
                                                            Avg.{" "}
                                                            {formatCurrency(
                                                                transactionData?.avg_monthly_daily_revenue ||
                                                                    0,
                                                            )}
                                                            /day
                                                        </p>
                                                    ...
                                                    <div className="space-y-1">
                                                        ...
                                                        <p className="text-xl lg:text-2xl font-bold">
                                                            {formatCurrency(
                                                                transactionData?.this_month_net_profit ||
                                                                    0,
                                                            )}
                                                        </p>
                                                        <p className="text-xs text-muted-foreground">
                                                    ...
                                                    <div className="space-y-1">
                                                        ...
                                                        <p className="text-xl lg:text-2xl font-bold">
                                                            {transactionData?.monthly_sales_volume ||
                                                                0}
                                                        </p>
                                                        <p className="text-xs text-muted-foreground">
                                                            Avg.{" "}
