                ...
                <div className="text-center max-w-4xl mx-auto px-4 relative z-10">
                    ...
                    >
                        ...
                        <motion.span
                            ...
                            initial={{ opacity: 0 }}
                            animate={
                                heroInView ? { opacity: 1 } : { opacity: 0 }
                            }
                    ...
                    >
                        Manage items, track transactions, analyze revenues, and
                        gain insights with powerful charts. Secure and easy for
                        any business.
                    </motion.p>
                    <motion.div
                        initial={{ opacity: 0, y: 30 }}
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {[
                            ...
                            },
                            {
                                title: "Inventory Management",
                                description:
                                    "Manage items and transactions seamlessly.",
                            },
                            {
